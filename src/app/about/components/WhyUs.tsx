      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20">
        ...
        <div className="md:sticky md:top-32 h-fit">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-6xl font-heading font-semibold tracking-tight leading-[1.05] text-neutral-900"
          >
            We build{" "}
          ...
          {points.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                {/* title */}
                <h3
                  className={`text-2xl md:text-3xl font-heading font-semibold mb-3 transition-all duration-300 ${
